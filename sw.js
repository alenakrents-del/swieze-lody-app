...
const COMIC_ART = new Set(['01','02','03'].flatMap(panel => [360,720,900].map(width =>
  new URL(`assets/comic/season-1/episode-01-panel-${panel}-v2-${width}.webp`, self.location.href).href
)));
