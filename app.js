...
document.querySelectorAll('[data-info]').forEach(btn => {
  btn.onclick = () => {
    if (btn.dataset.info === 'icecream') openInfo('🍦 ' + tr('iceCream'), tr('icecreamInfo'));
    if (btn.dataset.info === 'coffee') openInfo('☕ ' + tr('coffee'), tr('coffeeInfo'));
    if (btn.dataset.info === 'secret') openInfo('🔒 Secret Menu', tr('secretInfo'));
  };
});
